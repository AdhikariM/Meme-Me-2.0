...
class MemeEditorViewController: UIViewController, UIImagePickerControllerDelegate,
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        specifyTextField(topTextField, "TOP")
        specifyTextField(bottomTextField, "BOTTOM")
    ...
    func saveMeme() {
        ...
        let meme = MemeMe(topTextField: topTextField.text!, bottomTextField: bottomTextField.text!, ogImage: memeImageView.image!, memeImage: memeImage)
